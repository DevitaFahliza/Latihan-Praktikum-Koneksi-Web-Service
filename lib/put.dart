...
class MyAppState extends State<MyApp> {
  ...
  String url = "http://127.0.0.1:8000/update_mhs_put/"; // URL endpoint untuk mengupdate data mahasiswa menggunakan metode PUT

  // Fungsi untuk mengirim permintaan PUT untuk memperbarui data mahasiswa
  Future<int> fetchData() async {
    ...
    final response = await http.put(
      ...
      "id_prov": "142",
      "angkatan": "2022",
      "tinggi_badan": 192} """, // Data mahasiswa yang akan diperbarui
    );
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    if (snapshot.data! == 200) {
                      return Text("Proses Update Berhasil!"); // Pesan jika proses berhasil
                    }
                    if (snapshot.data! == 0) {
